  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span
          className={`ml-auto text-sm font-semibold px-3 py-1 rounded-full ${isDarkMode ? 'bg-emerald-900/40 text-emerald-300' : 'bg-emerald-100 text-emerald-700'}`}
        >
          {users.length}
        </span>
      </div>
      ...
      {loading && (
        <motion.div layout className="text-center text-slate-400 py-8">
          ...
          <AnimatePresence>
            {users.map((user) => (
              ...
              >
                ...
                {/* Name */}
                <p
                  className={`text-sm font-semibold text-center truncate w-full px-1 ${isDarkMode ? 'text-white' : 'text-slate-800'}`}
                >
                  {user.nickname}
                </p>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span
                    className={`text-xs font-medium ${isDarkMode ? 'text-emerald-300' : 'text-emerald-600'}`}
                  >
                    Online
                  </span>
                </div>
