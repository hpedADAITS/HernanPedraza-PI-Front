 ...
 */
export function formatEventStatus(status: string): { label: string; style: string } {
  ...
  return statusMap[status] || { label: status, style: "bg-gray-100 text-gray-800" };
}

/**
 * Format song status
 */
export function formatSongStatus(
  status: string
